let comprarProducto = prompt("Ingresa el número del producto que quieres comprar. \nSi deseas salir ingresa EXIT. \n(Opciones: \n 1 = Microprocesador Intel i7, \n 2 = Microprocesador Intel i9, \n 3 = Microprocesador AMD Ryzen 7, \n 4 = Microprocesador AMD Ryzen 9, \n 5 = Placa de Video RTX3080, \n 6 = Placa de Video RTX3090, \n 7 = Placa de Video RX6800, \n 8 = Placa de Video RX6900, \n 9 = Motherboard ASUS ROG MAXIMUS Z690, \n 10 = Motherboard AORUS X570S ELITE, \n 11 = Motherboard ASUS Z690PLUS TUF GAMING, \n 12 = Motherboard GIGABYTE B550 AORUS PRO, \n EXIT = Salir)");
...
while (comprarProducto != "EXIT") {
    let cantidadProducto = parseFloat(prompt("Ingresa la cantidad de unidades del producto seleccionado que quieres agregar a tu compra"));
    if (isNaN(cantidadProducto)) {
        alert("Usted no ingresó una cantidad válida. \nPor favor intente nuevamente.");
    } else {
        switch (comprarProducto) {
            ...
            case "5":
                if (producto5.stock == 0) {
                    ...
                    alert("No hay suficiente stock. Actualmente disponemos de " + producto5.stock + " unidad/es de este producto.");
                } else {
                    producto5.vendido(cantidadProducto);
                    carrito.push(cantidadProducto, producto5);
                    alert("Usted seleccionó " + cantidadProducto + " Placa/s de Video RTX3080 \nDeberá abonar un total de $ " + producto5.precio * cantidadProducto);
                    console.log("Se vendió un total de " + cantidadProducto + " Placa/s de Video " + producto5.tittle + " por un valor total de $ " + producto5.precio * cantidadProducto);
            ...
            case "6":
                if (producto6.stock == 0) {
                    ...
                    alert("No hay suficiente stock. Actualmente disponemos de " + producto6.stock + " unidad/es de este producto.");
                } else {
                    producto6.vendido(cantidadProducto);
                    carrito.push(cantidadProducto, producto6);
                    alert("Usted seleccionó " + cantidadProducto + " Placa/s de Video RTX3090 \nDeberá abonar un total de $ " + producto6.precio * cantidadProducto);
                    console.log("Se vendió un total de " + cantidadProducto + " Placa/s de Video " + producto6.tittle + " por un valor total de $ " + producto6.precio * cantidadProducto);
            ...
            case "7":
                if (producto7.stock == 0) {
                    ...
                    alert("No hay suficiente stock. Actualmente disponemos de " + producto7.stock + " unidad/es de este producto.");
                } else {
                    producto7.vendido(cantidadProducto);
                    carrito.push(cantidadProducto, producto7);
                    alert("Usted seleccionó " + cantidadProducto + " Placa/s de Video RX6800 \nDeberá abonar un total de $ " + producto7.precio * cantidadProducto);
                    console.log("Se vendió un total de " + cantidadProducto + " Placa/s de Video " + producto7.tittle + " por un valor total de $ " + producto7.precio * cantidadProducto);
            ...
            case "8":
                if (producto8.stock == 0) {
                    ...
                    alert("No hay suficiente stock. Actualmente disponemos de " + producto8.stock + " unidad/es de este producto.");
                } else {
                    producto8.vendido(cantidadProducto);
                    carrito.push(cantidadProducto, producto8);
                    alert("Usted seleccionó " + cantidadProducto + " Placa/s de Video RX6900 \nDeberá abonar un total de $ " + producto8.precio * cantidadProducto);
                    console.log("Se vendió un total de " + cantidadProducto + " Placa/s de Video " + producto8.tittle + " por un valor total de $ " + producto8.precio * cantidadProducto);
            ...
            case "9":
                if (producto9.stock == 0) {
                    ...
                    alert("No hay suficiente stock. Actualmente disponemos de " + producto9.stock + " unidad/es de este producto.");
                } else {
                    producto9.vendido(cantidadProducto);
                    carrito.push(cantidadProducto, producto9);
                    alert("Usted seleccionó " + cantidadProducto + " Motherboard/s ASUS ROG MAXIMUS Z690 \nDeberá abonar un total de $ " + producto9.precio * cantidadProducto);
                    console.log("Se vendió un total de " + cantidadProducto + " Motherboard/s " + producto9.tittle + " por un valor total de $ " + producto9.precio * cantidadProducto);
            ...
            case "10":
                if (producto10.stock == 0) {
                    ...
                    alert("No hay suficiente stock. Actualmente disponemos de " + producto10.stock + " unidad/es de este producto.");
                } else {
                    producto10.vendido(cantidadProducto);
                    carrito.push(cantidadProducto, producto10);
                    alert("Usted seleccionó " + cantidadProducto + " Motherboard/s AORUS X570S ELITE \nDeberá abonar un total de $ " + producto10.precio * cantidadProducto);
                    console.log("Se vendió un total de " + cantidadProducto + " Motherboard/s " + producto10.tittle + " por un valor total de $ " + producto10.precio * cantidadProducto);
            ...
            case "11":
                if (producto11.stock == 0) {
                    ...
                    alert("No hay suficiente stock. Actualmente disponemos de " + producto11.stock + " unidad/es de este producto.");
                } else {
                    producto11.vendido(cantidadProducto);
                    carrito.push(cantidadProducto, producto11);
                    alert("Usted seleccionó " + cantidadProducto + " Motherboard/s ASUS Z690PLUS TUF GAMING \nDeberá abonar un total de $ " + producto11.precio * cantidadProducto);
                    console.log("Se vendió un total de " + cantidadProducto + " Motherboard/s " + producto11.tittle + " por un valor total de $ " + producto11.precio * cantidadProducto);
            ...
            case "12":
                if (producto12.stock == 0) {
                    ...
                    alert("No hay suficiente stock. Actualmente disponemos de " + producto12.stock + " unidad/es de este producto.");
                } else {
                    producto12.vendido(cantidadProducto);
                    carrito.push(cantidadProducto, producto12);
                    alert("Usted seleccionó " + cantidadProducto + " Motherboard/s GIGABYTE B550 AORUS PRO \nDeberá abonar un total de $ " + producto12.precio * cantidadProducto);
                    console.log("Se vendió un total de " + cantidadProducto + " Motherboard/s " + producto12.tittle + " por un valor total de $ " + producto12.precio * cantidadProducto);
        ...
        comprarProducto = prompt("Ingresa el número del producto que quieras agregar. \nO ingresa EXIT para salir. \n(Opciones: \n 1 = Microprocesador Intel i7, \n 2 = Microprocesador Intel i9, \n 3 = Microprocesador AMD Ryzen 7, \n 4 = Microprocesador AMD Ryzen 9, \n 5 = Placa de Video RTX3080, \n 6 = Placa de Video RTX3090, \n 7 = Placa de Video RX6800, \n 8 = Placa de Video RX6900, \n 9 = Motherboard ASUS ROG MAXIMUS Z690, \n 10 = Motherboard AORUS X570S ELITE, \n 11 = Motherboard ASUS Z690PLUS TUF GAMING, \n 12 = Motherboard GIGABYTE B550 AORUS PRO, \n EXIT = Salir)");
    }
}
