function Producto(id, tittle, precio, stock, disponible) {
    ...
    this.calcularStock = function () {
        if (this.stock <= 0) {
            return (this.disponible = false) || (this.stock = "Sin stock");
        } else {
            return this.stock;
        }
    };
...
let producto1 = new Producto(1, "i7", "60000", 5, true);
...
while (comprarProducto != "EXIT") {
    ...
    switch (comprarProducto) {
        case "1":
            ...
            console.log("Se vendió un total de " + cantidadProducto + " Microprocesadores " + producto1.tittle + " por un valor total de $ " + producto1.precio * cantidadProducto);
        ...
        case "2":
            ...
            console.log("Se vendió un total de " + cantidadProducto + " Microprocesadores " + producto2.tittle + " por un valor total de $ " + producto2.precio * cantidadProducto);
